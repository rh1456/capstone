...
const CreateAccount = () => {
  ...
  const [interestedAges, setInterestedAges] = useState([])
  const [interestedAgeId, setInterestedAgeId] = useState()
  ...
  const submitData = async event => {
    ...
    const resp = await axios.post('https://localhost:5001/api/User/', {
      ...
      interestedAgeId: parseInt(interestedAgeId),
    })
        ...
        >
          ...
          <section className="create-account-details">
            ...
            >
              ...
              {interestedAgess.map(interestedAge => {
                return (
